...
const evalCases = {
  ...
  cheatsheet: {
    id: "cheatsheet",
    title: "Reference cheatsheet board",
    source: join(evalCaseRoot, "reference-cheatsheet.md"),
    expectedPlaybook: "article-visual with editorial-layouts, especially E13 Reference Cheatsheet",
    prompt:
      "Create one editable reference cheatsheet. Use a strict grid, visible anchor rail, compact example blocks, and one highlighted default path. Avoid a tiny unreadable table.",
  },
  "flow-volume": {
    id: "flow-volume",
    title: "Flow volume map board",
    source: join(evalCaseRoot, "flow-volume-map.md"),
    expectedPlaybook: "article-visual with editorial-layouts, especially E14 Flow Volume Map",
    prompt:
      "Create one editable flow-volume map. Show sources, stages, outputs, relative volume, one leakage point, and one leverage insight. Avoid a generic process flowchart.",
  },
  "milestone-ribbon": {
    id: "milestone-ribbon",
    title: "Milestone ribbon board",
    source: join(evalCaseRoot, "milestone-ribbon.md"),
    expectedPlaybook: "article-visual with editorial-layouts, especially E15 Milestone Ribbon",
    prompt:
      "Create one editable milestone ribbon visual. Make it feel like a product/version story with alternating milestone cards and one highlighted turning point. Avoid a plain same-size timeline.",
  },
  flow: {
    id: "flow",
...
function caseAlias(value) {
  ...
  const aliases = {
    ...
    funnel: "flow-volume",
    sankey: "flow-volume",
    conversion: "flow-volume",
    volume: "flow-volume",
    throughput: "flow-volume",
    milestone: "milestone-ribbon",
    milestones: "milestone-ribbon",
    ribbon: "milestone-ribbon",
    roadmap: "milestone-ribbon",
    version: "milestone-ribbon",
    release: "milestone-ribbon",
    ppt: "ppt",
    slide: "ppt",
    slides: "ppt",
    flow: "flow",
